...
export default function AdminReports() {
  ...
  const setStatus = (id, s) =>
    setReports((r) => r.map((x) => (x.id === id ? { ...x, status: s } : x)));
          ...
          <div key={r.id} className="p-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-3 py-1 bg-green-50 text-green-700 rounded-lg flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-3 py-1 bg-red-50 text-red-700 rounded-lg flex items-center gap-2"
              >
                <X className="w-4 h-4" />
                Từ chối
              </button>
