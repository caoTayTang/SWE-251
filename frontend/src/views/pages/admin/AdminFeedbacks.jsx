...
const mock = [
  {
    id: 1,
    user: "Tutee: Trần Thị B",
    topic: "Báo lỗi hệ thống",
    body: "Không upload được file",
    status: "new",
    created: "2025-10-27",
  },
  {
    id: 2,
    user: "Tutor: Nguyễn Văn A",
    topic: "Yêu cầu tính năng mới",
    body: "Thêm filter theo level",
    status: "inprogress",
    created: "2025-10-26",
  },
];
...
export default function AdminFeedbacks() {
  ...
  const mark = (id, s) =>
    setItems((it) => it.map((i) => (i.id === id ? { ...i, status: s } : i)));
            ...
            <div className="text-right">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1 text-sm bg-green-50 text-green-700 rounded-lg"
                >
